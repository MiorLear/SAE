              ...
              value: function (t) {
                ...
                if (
                  ...
                  (!A.config.chart.dropShadow.enabledSeries ||
                    (A.config.chart.dropShadow.enabledSeries &&
                      -1 !==
                        A.config.chart.dropShadow.enabledSeries.indexOf(s)))
                ) {
                ...
                return (
                  !L || A.globals.resized || A.globals.dataChanged
                    ...
                    : C.animatePathsGradually(n({}, I, { speed: f, delay: d })),
                  A.globals.dataChanged &&
                    z &&
                    P &&
                    C.animatePathsGradually(n({}, I, { speed: p })),
                  T
                );
              },
            },
            ...
            value: function (t) {
              ...
              return (
                ...
                -1 === r.indexOf("rgb")
                  ? (h = d.hexToRgba(r, l))
                  : r.indexOf("rgba") > -1 &&
                    (l = "0." + d.getOpacityFromRGBA(r)),
                "pattern" === o && (s = this.handlePatternFill(s, r, l, h)),
                "gradient" === o &&
                  (a = this.handleGradientFill(a, r, l, this.seriesIndex)),
                ...
                for (var h = 0; h < r.x.length; h++) {
                  ...
                  if (
                    ...
                    a.config.series[n].data[i] &&
                      (a.config.series[n].data[i].fillColor &&
                        (p.pointFillColor =
                          a.config.series[n].data[i].fillColor),
                      a.config.series[n].data[i].strokeColor &&
                        (p.pointStrokeColor =
                          a.config.series[n].data[i].strokeColor)),
            ...
            value: function (t) {
              ...
              if (
                ...
                if (
                  ...
                  p.textRects &&
                    (s + p.textRects.width < 10 ||
                      s > e.globals.gridWidth + 10) &&
                    (o = ""),
                  p.drawnextLabel)
                ) {
                  var x = i.drawText({
                  ...
                  s.push({
                    ...
                    icon:
                      "string" == typeof this.t.download
                        ? this.t.download
                        : '<svg width="24" height="24" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0V0z"/><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"/></svg>',
